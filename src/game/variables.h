...
MACRO_CONFIG_STR(SvMotd, sv_motd, 900, "Teefoot by is currently maintained by [Egypt]GreYFoX@GTi it was originally made by Bass, unlimreal, GreYFoX... and more \n\n\n How to play? \n\n It's simply,\n get the Ball and shot Goals!\n\n If an enemy got the Ball you can  steel him the ball by hammering  him \n\n\n That all you have to know! \n\n\n\n Have fun with playing! \n\n\n PLease report bugs to github.com/GreYFoX/teeworlds/issues\n soon http://teefoot.info", CFGFLAG_SERVER, "Message of the day to display for the clients")
...
MACRO_CONFIG_STR(SvGametype, sv_gametype, 32, "Foot", CFGFLAG_SERVER, "Game type (dm, tdm, ctf or Foot)")
